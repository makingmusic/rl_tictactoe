...
class GameDisplay:
    ...
    def display_board(self, game, move_info: Optional[str] = None, game_info: Optional[str] = None):
        """
    ...
    def display_game_summary(self, game, total_moves: int):
        """
        Display a summary of the completed game.
        ...
        """
        # Game results:
        winner_string = "X" if game.winner == "X" else "O" if game.winner == "O" else "NOBODY"
